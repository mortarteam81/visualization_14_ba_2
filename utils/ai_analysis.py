            ...
            comparisons.append(
                {
                    ...
                    "gap_vs_group_average": round(school_row["latest_value"] - latest_average, 2),
                }
            )
        ...
        group_rows.append(
            {
                ...
                "average_trend": _trend_label(_recent_points(average_frame, year_col=year_col, value_col=value_col)),

...
_FULLTIME_ADJUNCT_FACULTY = get_metric("fulltime_adjunct_faculty")
FULLTIME_ADJUNCT_FACULTY_CSV = _FULLTIME_ADJUNCT_FACULTY.csv_file
FULLTIME_ADJUNCT_FACULTY_CSV_ENCODING = _FULLTIME_ADJUNCT_FACULTY.csv_encoding
FULLTIME_ADJUNCT_FACULTY_DEFAULT_SCHOOL = _FULLTIME_ADJUNCT_FACULTY.default_school
FULLTIME_ADJUNCT_FACULTY_PAGE_TITLE = _FULLTIME_ADJUNCT_FACULTY.title
FULLTIME_ADJUNCT_FACULTY_PAGE_ICON = _FULLTIME_ADJUNCT_FACULTY.icon
...
_SCHOLARSHIP_RATIO = get_metric("scholarship_ratio")
SCHOLARSHIP_RATIO_CSV = _SCHOLARSHIP_RATIO.csv_file
SCHOLARSHIP_RATIO_CSV_ENCODING = _SCHOLARSHIP_RATIO.csv_encoding
SCHOLARSHIP_RATIO_DEFAULT_SCHOOL = _SCHOLARSHIP_RATIO.default_school
SCHOLARSHIP_RATIO_PAGE_TITLE = _SCHOLARSHIP_RATIO.title
SCHOLARSHIP_RATIO_PAGE_ICON = _SCHOLARSHIP_RATIO.icon
SCHOLARSHIP_RATIO_COL = get_series("scholarship_ratio").column

_CORP_TRANSFER_RATIO = get_metric("corp_transfer_ratio")
CORP_TRANSFER_RATIO_CSV = _CORP_TRANSFER_RATIO.csv_file
CORP_TRANSFER_RATIO_CSV_ENCODING = _CORP_TRANSFER_RATIO.csv_encoding
CORP_TRANSFER_RATIO_DEFAULT_SCHOOL = _CORP_TRANSFER_RATIO.default_school
CORP_TRANSFER_RATIO_PAGE_TITLE = _CORP_TRANSFER_RATIO.title
CORP_TRANSFER_RATIO_PAGE_ICON = _CORP_TRANSFER_RATIO.icon
CORP_TRANSFER_RATIO_COL = get_series("corp_transfer_ratio").column

...
ANALYSIS_LOADERS: Final[tuple[LoaderSpec, ...]] = (
    ...
    LoaderSpec(
        ...
        (
            InsightMetricSpec(
                key="fulltime_adjunct_faculty_quota_rate",
                label="전임교원 및 겸임교원 확보율(편제정원)",
                source_metric_id="fulltime_adjunct_faculty",
                source_column=FULLTIME_ADJUNCT_FACULTY_COL_QUOTA_RATE,
                unit="%",
                group="교원",
                decimals=3,
            ),
            InsightMetricSpec(
                key="fulltime_adjunct_faculty_enrolled_rate",
                label="전임교원 및 겸임교원 확보율(재학생)",
                source_metric_id="fulltime_adjunct_faculty",
                source_column=FULLTIME_ADJUNCT_FACULTY_COL_ENROLLED_RATE,
                unit="%",
                group="교원",
                decimals=3,
            ),

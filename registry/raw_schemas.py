...
UNREGISTERED_RAW_CSV_ALLOWLIST: Final[frozenset[Path]] = frozenset(
    ...
    for path in (
        ...
        "data/conversion_outputs/kasfo/education_return/kasfo_education_return_2016_2025_candidate.csv",
        "data/conversion_outputs/kasfo/education_return/kasfo_education_return_theme_issue_2020_2025_candidate.csv",
        "data/conversion_outputs/kasfo/gyeolsan/kasfo_gyeolsan_2015_2024_candidate.csv",
        ...
        "data/conversion_outputs/kcue/staff_per_student_2015_2025_candidate.csv",
        ...
        "data/validation/mismatch_reports/kasfo_education_return.mismatch.csv",
        "data/validation/mismatch_reports/kasfo_education_return_formula_source_gap.csv",
        "data/validation/mismatch_reports/kasfo_education_return_theme_issue_crosscheck.csv",
        "data/validation/mismatch_reports/kasfo_gyeolsan.mismatch.csv",
        ...
        "data/validation/mismatch_reports/kcue_staff_per_student_download_crosscheck.csv",
        "data/validation/mismatch_reports/kcue_staff_per_student.mismatch.csv",
